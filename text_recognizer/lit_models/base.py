...
class Accurarcy(pl.metrics.Accurarcy):
...
class BaseLitModel(pl.LightningModule):
    ...
    def __init__(self, model, args: argparse.Namespace = None):
    	...
    	self.train_acc = Accurarcy()
    	self.val_acc = Accurarcy()
    	self.test_acc = Accurarcy()
    ...
    def validation_step(self, batch, batch_idx):
    	...
    	self.log("val_acc", self.test_acc,on_step=False, on_epoch=True, prog_bar=True)
